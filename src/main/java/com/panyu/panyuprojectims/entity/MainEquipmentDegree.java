...
public class MainEquipmentDegree {
    ...
    private String equipmentProgress;
    private String equipmentCompletionDate;
    public MainEquipmentDegree() {
        super();
    }
    public MainEquipmentDegree(String mainEquipmentId,String equipmentConstructionMode,String equipmentTypeName,String equipmentSupplierName,String equipmentSupplierContacts,String equipmentUnitName,String equipmentUnitContacts,String equipmentProgress,String equipmentCompletionDate) {
        super();
    ...
    public String getEquipmentCompletionDate() {
        return this.equipmentCompletionDate;
    }
